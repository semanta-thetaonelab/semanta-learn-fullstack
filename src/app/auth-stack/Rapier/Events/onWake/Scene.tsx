...
// onWake event is trigger when the object start rotate or movement
...
const Scene = () => {
    ...
    return (<>
        ...
        <RigidBody type="dynamic" gravityScale={1} position={[-2,10,0]} colliders='cuboid' name="ball"
        >
        <mesh castShadow>
            <sphereGeometry/>
        ...
        <RigidBody type="dynamic" gravityScale={2} ref={box} position={[5,10,0]} colliders='cuboid' name="cube"
         onWake={()=>{console.log('Cube RigidBody Wake up')}}
        >
        <mesh castShadow scale={2} onClick={()=>{move()}}>
            <boxGeometry/>
